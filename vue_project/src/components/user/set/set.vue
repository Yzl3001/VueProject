				...
				<div class="content-user-left">
					<div class="content-user-left-panel">
						<div class="content-user-left-panel-body">
							<a href=""><img :src="imgObjname" :class="imageHP[0]"></a>
					...
					<div class="content-user-right-panel">
						<div class="content-user-right-panel-body">
							...
							<div style="margin-top: 20px; margin-left: 20px;">
								...
								<el-color-picker v-model="BackGroundcolor" v-on:change="Changethecolor"></el-color-picker>
								<!-- <el-color-picker v-model="BackGroundcolor" v-on:change="baccolo"></el-color-picker> -->
							</div>
...
export default {
    ...
    methods: {
		...
		Thetoolbar:function() {
			const flag = this.valuebut
			console.log(flag)
			if (flag == false) {
				document.getElementById("botp").style.display = "none";
			}
			else if (flag == true) {
				document.getElementById("botp").style.display = "block";
			}
		},
		Changethecolor:function() {
			var changethecolor = this.BackGroundcolor
			document.getElementById("Index").style.background= changethecolor;
		}
	},
	created() {
