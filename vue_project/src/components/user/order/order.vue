				...
				<div class="content-user-left">
					<div class="content-user-left-panel">
						<div class="content-user-left-panel-body">
							<a href="javascript:;"><img :src="imgObjname" :class="imageHP[0]"></a>
							<hr style="margin-top: 20px; margin-bottom: 20px;">
							<div class="content-user-left-panel-body-name" style="text-align: center;">
								{{userAccount}}
							</div>
							...
							<div style="height: 40px;">
								<a href="#/myspace" style="float: left; margin-left: 15px;">
									<div style="text-align: center; color: #99a2aa;">
										关注数
									</div>
					...
					<div class="content-user-right-panel">
						<div class="content-user-right-panel-body">		
							...
							<div>
								...
								<div class="content-2-div-pbm" v-for="i in 10">
							
									<div v-if="i % 2 != 0" style="background-color: #f9f9f9; height: 41px;">
										<div style="padding: 8px;">	
											<a href="#/solution" style="color: #337ab7; margin-left: 10px;">
												<img src="../../../assets/image/tupian.png" style="height: 24px; width: 24px; vertical-align: middle;">					
											</a>
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											<a href="" style="color: blue;">xxxxx</a>
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											<td>xx</td>								
											<a href="#/solution" style="margin-left: 50px; color: #337ab7;">
												xxxx
											</a>												
											<span style="margin-left: 100px;">xx天前</span>
											<a href="" style="margin-left: 90px; color: blue;">
												xx
											</a>										
										</div>									
									</div>
...
<style type="text/css" scoped>
	...
	.content-user-right-panel-body>div>ul {
		border-bottom: 1px solid #ddd;
	}

	.content-user-right-panel-body>div>ul>li {
		float: left;
		height: 30px;
		width: 67px;
		display: block;
	...
	.content-user-right-panel-body>div>ul>li>a {
		padding: 10px 15px;
