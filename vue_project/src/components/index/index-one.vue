			...
			<div class="dh_top">
				<el-menu class="el-menu-demo" mode="horizontal" @select="handleSelect">
					...
					<el-sub-menu index="8">
						...
						<el-menu-item index="8-1"><a href="#/myspace" target="_blank">我的空间</a></el-menu-item>
						<el-menu-item index="8-2"><a href="#/information" target="_blank">个人信息</a></el-menu-item>
						<el-menu-item index="8-3"><a href="#/order" target="_blank">我的订单</a></el-menu-item>
						<el-menu-item index="8-4"><a href="#/set">设置</a></el-menu-item>
						<el-menu-item index="8-5"><a v-on:click="Exit()"> 退出</a></el-menu-item>
					</el-sub-menu>
		...
		<div class="content"> <!-- 内容 -->
			...
			<div class="content-1">
				<div class="content-1-1">               
					<h2 style="line-height: 20px; font-size: medium; font-weight: bold;">推荐</h2>							
					<hr style="margin: 0 0 10px 0;">
					<el-carousel :interval="4000" type="card" height="200px">
						<el-carousel-item v-for="item in 4" :key="item" :class="images[ item - 1 ]" v-on:click="jump(item)">
						</el-carousel-item>
					</el-carousel>
				</div>
			</div>
			...
			<div class="content-2">
				<div class="content-2-1" v-for="i in count">
					<div class="infinite-list-wrapper" style="overflow:auto">

						<div>
							热点						
							<a href="" target="_blank" style="margin-left: 590px;"><span style="color: black;">详情</span></a>
							<hr style="margin: 0 0 10px 0;">
						</div>
						...
						<hr style="margin: 30px 0 10px 0;">
							<div class="content-2-1-div" style="height: 30px; width: 150px; margin: 0 auto; float: left;">
								<el-rate v-model="value[ i ]" show-score text-color="#95a5a6" score-template="{value}"></el-rate>
							</div>
							<div class="content-2-1-zan content-2-1-div">
								<el-badge class="item">
									<a class="btn-link" title="评论" style="cursor: pointer;">
									<span class="glyphicon" style="top: 2px;">	
										<img src="../../assets/image/pinglun.png" style="height: 14px; width: 16px; margin-right: -7px;">
									</span>
									&nbsp;
									<span>
										评论
							...
							<div class="content-2-1-div" style="height: 30px; width: 150px; margin: 0 auto; float: left;">
								<a class="btn-link" title="收藏" style="cursor: pointer;">
									<span class="glyphicon" style="top: 2px;">	
										<img src="../../assets/image/shoucang.png" style="height: 14px; width: 16px; margin-right: -7px;">
									</span>
									&nbsp;
									<span>
										收藏
							...
							<hr style="margin: 0 0 10px 0; width: 683px;">
						</div>						
					</div>
				</div>
				<div v-if="noMore">
